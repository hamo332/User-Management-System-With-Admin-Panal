...
if (isset($_POST['action'])&& $_POST['action'] == "adminLogin")
{
    ...
    if ($loggedInAdmin != null)
    {
        ...
        echo $admin->showMessage('danger', 'Password or Username is incorrect!');
    }
}
...
if (isset($_POST['action'])&& $_POST['action'] == "fetchAllUsers")
{
    ...
    if ($data) {
        $output .= '<table class="table table-striped table-border text-center">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Image</th>
                                ...
                                foreach ($data as $row)
                                {
                                    ...
                                    $output .= '<tr>
                                        ...
                                        <td>
                                            ...
                                            class="text-danger deleteUserIcon">
...
if (isset($_POST['action'])&& $_POST['action'] == "fetchAllDeletedUsers")
{
                                ...
                                foreach ($data as $row)
                                {
                                    ...
                                    $output .= '<tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" id="'.$row['id'].'" title="Restor User"
                                            class="text-white restorUserIcon badge badge-dark p-2">
                                                Restor
                                            </a>
                                        </td>
    ...
    // Handle Restor Deleted User Ajax Request
                                ...
                                foreach ($note as $row)
                                {
                                    ...
                                    $output .= '<tr>
                                        ...
                                        <td>
                                            ...
                                            class="text-danger deleteNoteIcon">
                                                <i class="fas fa-trash-alt fa-lg"></i>
                                            </a>
                                        </td>
...
// Handle Delete Note of An Usre Ajax Request
                                ...
                                foreach ($feedback as $row)
                                {
                                    ...
                                    $output .= '<tr>
                                        ...
                                        <td>
                                            ...
                                            class="text-primary replyFeedbackIcon" data-toggle="modal" data-target="#showReplyModal">
...
if (isset($_POST['action']) && $_POST['action'] == 'fetchNotification')
{
    ...
    if($notification)
    {
        ...
        {
            $output .= '
                <div class="alert alert-dark" rol="alert">
