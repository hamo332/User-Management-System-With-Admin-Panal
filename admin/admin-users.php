...
?>
        ...
        <div class="col-lg-12">
            <div class="card my-2 border-success">
                <div class="card-header bg-success text-white">
                    <h4 class="m">Total Regsitered Users</h4>
                </div>
                <div class="card-body">
    ...
    <!-- Start Display User's In Details Modal -->
    ...
    <!-- End Display User's In Details Modal -->
</div>
</div>
</div>
        ...
        $.ajax(
            {
                ...
                success: function(response)
                {
                    ...
                    {
                        $("#getImage").html(
                            `<img src="../assets/php/${data.photo}"
                            class="img-thumbnail img-fluid align-self-center"
                            with="280px" />`
                        );    
                    }else{
                        $("#getImage").html(
